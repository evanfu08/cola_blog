...
const COLOR_PRESETS: ColorPreset[] = [
	{
		...
		backgroundColors: ['#E3F2FD', '#BBDEFB', '#90CAF9', '#64B5F6', '#42A5F5', '#2196F3']
	},
	{
		name: '春暖',
		theme: {
	...
	},
	{
		...
		theme: {
			colorBrand: '#00D9FF',
			colorBrandSecondary: '#B388FF',
			colorPrimary: '#1A1A2E',
			colorSecondary: '#6C757D',
			colorBg: '#0F0F23',
			colorBorder: '#2A2A4E',
			colorCard: '#1E1E3F99',
			colorArticle: '#2A2A4Ecc'
		},
		backgroundColors: ['#00D9FF', '#B388FF', '#7C4DFF', '#536DFE', '#448AFF', '#00D9FF']
	},
	{
		name: '森林',
		theme: {
			colorBrand: '#4CAF50',
			colorBrandSecondary: '#81C784',
			colorPrimary: '#2E7D32',
		...
		backgroundColors: ['#C8E6C9', '#A5D6A7', '#81C784', '#66BB6A', '#4CAF50', '#43A047']
	},
	{
		name: '日落',
		theme: {
			colorBrand: '#FF6B6B',
			colorBrandSecondary: '#FFD93D',
			colorPrimary: '#4A4A4A',
			colorSecondary: '#8B8B8B',
			colorBg: '#FFF5E1',
			colorBorder: '#FFFFFF',
			colorCard: '#FFFFFF77',
			colorArticle: '#FFFFFFbb'
		},
		backgroundColors: ['#FFD93D', '#FF6B6B', '#F4A261', '#E76F51', '#FF8C42', '#FFD93D']
	}
]
